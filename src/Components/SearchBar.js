    ...
    <>
      <form className="w-[70%] p-2">
        <label className="relative block">
          <input
            className="w-full bg-[#9b9b9b] placeholder:font-italitc border placeholder:text-[#4A4A4A] border-slate-400 drop-shadow-md rounded-md py-2 pl-3 pr-10 focus:outline-none"
